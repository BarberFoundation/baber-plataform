...
const ERROR_CODE_TO_STATUS: Record<string, HttpStatus> = {
  ...
  CANNOT_REVOKE_CURRENT_SESSION: HttpStatus.BAD_REQUEST,
  STAMP_CARD_CONFIG_NOT_FOUND: HttpStatus.NOT_FOUND,
  STAMP_CARD_NOT_FOUND:        HttpStatus.NOT_FOUND,
  INVALID_STAMP_CARD_CONFIG:   HttpStatus.BAD_REQUEST,
  INVALID_REDEMPTION_AMOUNT:   HttpStatus.BAD_REQUEST,
  INSUFFICIENT_CREDIT:         HttpStatus.UNPROCESSABLE_ENTITY,
  SUBSCRIPTION_TIER_NOT_FOUND:              HttpStatus.NOT_FOUND,
  INVALID_SUBSCRIPTION_TIER:                HttpStatus.BAD_REQUEST,
  CLUB_SUBSCRIPTION_NOT_FOUND:              HttpStatus.NOT_FOUND,
  CLUB_SUBSCRIPTION_ALREADY_ACTIVE:         HttpStatus.CONFLICT,
  CLUB_SUBSCRIPTION_BLOCKED_BY_STAMP_CARD:  HttpStatus.CONFLICT,
